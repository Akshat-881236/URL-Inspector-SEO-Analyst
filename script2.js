(function () {
  ...
  const url1El = $('#url1');
  const url2El = $('#url2');
  const quick1El = $('#quick1');
  const quick2El = $('#quick2');
  ...
  // Quick select
  quick1El && quick1El.addEventListener('change', () => {
    if (quick1El.value) url1El.value = quick1El.value;
  });

  quick2El && quick2El.addEventListener('change', () => {
    if (quick2El.value) url2El.value = quick2El.value;
  });
